							  ...
							  $biaya = number_format($r['nilai_proyek'],2,',','.');
							   ?>
									...
									<h5><b> 
									  ...
									  <div><i class="fa fa-map-o text-green"></i> Lokasi : <?php echo "Kec. $r[nama_kec], "." $r[nama_kabkot]"." - $r[nama_prov]" ?></div><p>
									</b></h5>
							<?php
						}
				  }
					   ...
					   { 
						  ...
						  ?>
							...
							<?php
							   ...
							   if ($terlambat < 1)
							   {
								   echo "  Perkiraan durasi akhir proyek adalah <code>".number_format($tgl['durasi_proyek'],0)."</code> hari, ";
								   echo "  proyek tidak mengalami keterlambatan dan bisa selesai tepat waktu.";
							   }
							   else
							   {
