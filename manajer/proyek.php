<?php
include "header.php";
 $sql=mysql_query("SELECT * FROM proyek ORDER BY id_proyek DESC LIMIT 1");
						...
						<!-- form start -->
							...
							<form role="form" action="fungsi.php?proses=tambah_proyek" method="POST" class="form-horizontal" id="tambah">
							   ...
							   <input type="hidden" class="form-control" name="username" value="<?=$_SESSION['username']?>">
								...
								<label class="col-sm-2 control-label">Jumlah Biaya(Tanpa PPN): </label>
							    <div class="col-sm-3">
								  <div class="input-group">
                ...
                <thead>
                      ...
                      <?php
                        ...
                        $proyek = mysql_query("SELECT * FROM proyek
											   ...
											   JOIN kec ON proyek.id_kec = kec.id_kec GROUP BY id_proyek");
                        $no=0;
                        while($r=mysql_fetch_array($proyek)){
                          ...
                          ?>
                          <td>
                              <a href="edit_proyek.php?id_proyek=<?php echo $r['id_proyek']?>" class="btn btn-info btn-fill btn-sm" >Ubah</a>
                              <botton class="btn btn-danger btn-fill btn-sm"
                              data-toggle="modal" data-target="#myModal" data-whatever="fungsi.php?proses_hapus=hapus_proyek&id_proyek=<?=$r['id_proyek']?>"
                              >Hapus</botton></td>
                            </tr>
                          <?php 
                        }
